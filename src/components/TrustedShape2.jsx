export default function TrustedShapes() {
  ...
  const images = [
    ...
    '/images/trustedbrands/6848501b4bbcd35cb37348d6_Logo 7.avif',
  ];

  return (
    <section className="py-12">
      {/* Desktop: Shapes + Logos */}
      <div className="hidden md:flex justify-center items-center flex-wrap gap-1 px-2">
      ...
      {/* Mobile: Only Logos */}
      <div className="flex md:hidden justify-center items-center flex-wrap gap-6 px-4">
        {images.map((src, index) => (
          <img
            ...
            onError={(e) => {
              e.target.onerror = null;
              e.target.src = `https://via.placeholder.com/150x60/3b142b/ffffff?text=Brand+${index + 1}`;
            }}
          />
        ))}
      </div>
