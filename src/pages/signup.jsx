  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex flex-1 justify-center items-start pt-16 px-4 relative">
        ...
        {/* Login Box */}
        <div className="w-full max-w-md bg-white p-6 rounded-lg z-10 -mt-12 sm:mt-0">
          <h2 className="text-4xl text-black font-bold text-center mb-2">
            Create a free Wayground account
          </h2>
          ...
          <div className="flex flex-col gap-3">
            <Link to="/signup" className="w-full last:mb-0">
              <button className="w-full border border-gray-300 rounded-lg py-3 flex items-center justify-between px-4 hover:bg-gray-50" onClick={() => window.scrollTo(0, 0)}>
            ...
            <Link to="/signup" className="w-full mb-4 last:mb-0">
              <button className="w-full border border-gray-300 rounded-lg py-3 flex items-center justify-between px-4 hover:bg-gray-50" onClick={() => window.scrollTo(0, 0)}>
              <div className="flex items-center space-x-3">
                <img
